...
public class GenerateBoard : MonoBehaviour
{
    ...
    public bool wantParentForTheBoard = true,
        wantParentPivotOnCenter = true;
    ...
    public void SpawnElements()
    {
        ...
        if (wantParentForTheBoard)
        {
            ...
            if (wantParentPivotOnCenter)
            {
                ...
                Vector3 offsetToRemove =
                    new Vector3(
                        toSpawn[0].transform.localScale.x,
                        toSpawn[0].transform.localScale.y,
                        toSpawn[0].transform.localScale.z
                    ) / 2;

                parent.transform.position =
                    new Vector3(length / 2, height / 2, depth / 2) - offsetToRemove;
            }
